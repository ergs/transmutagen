cdef extern from "solve.h":
    ...
    void transmutagen_expm_multiply6(double*, double*, double*, double*)
    void transmutagen_expm_multiply8(double*, double*, double*, double*)
    void transmutagen_expm_multiply10(double*, double*, double*, double*)
    void transmutagen_expm_multiply12(double*, double*, double*, double*)
    void transmutagen_expm_multiply14(double*, double*, double*, double*)
    void transmutagen_expm_multiply16(double*, double*, double*, double*)
    void transmutagen_expm_multiply18(double*, double*, double*, double*)
