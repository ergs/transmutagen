cdef extern from "solve.h":
    ...
    void transmutagen_solve_complex(long double complex*, long double complex*, long double complex*)
    void transmutagen_diag_add_complex(long double complex*, long double complex)
    void transmutagen_dot_complex(long double complex*, long double complex*, long double complex*)
    void transmutagen_scalar_times_vector_complex(long double complex, long double complex*)
