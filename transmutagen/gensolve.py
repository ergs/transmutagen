...
void expm14(double complex* A, double complex* b, double complex* x) {
    ...
    transmutagen_solve_special_complex(A, 5.62314257274597712494520326004 + (-1.19406904634396697320055795941)*I, 27.8751619401456463960237466985 + (-102.147339990564514248579577671)*I, b, x0);
    transmutagen_solve_special_complex(A, 2.26978382923111270000297467973 + (-8.46173797304022139646316695686)*I, -4.80711209883250887291965497626 + (-1.32097938374287242475211680928)*I, b, x1);
    transmutagen_solve_special_complex(A, 3.99336971057856853025375498429 + (-6.00483164223503731596717948806)*I, 23.4982320910827012314190795608 + (-5.80835912971420750092857584133)*I, b, x2);
    transmutagen_solve_special_complex(A, 5.08934506058062450150096345613 + (-3.58882402902700651552894109753)*I, -46.9332744888312930359089080827 + 45.6436497688277607413919781939*I, b, x3);
    transmutagen_solve_special_complex(A, -0.20875863825013012197592074913 + (-10.9912605619012609176212156940)*I, 0.376360038782269688578990952196 + 0.335183470294501039620923752439*I, b, x4);
    transmutagen_solve_special_complex(A, -8.89777318646888881871224673753 + (-16.6309826199020853044092653271)*I, 0.0000715428806358906730643236773918 + 0.000143610433495413001443873463755*I, b, x5);
